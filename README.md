Using Github Pages with Github Actions, this creates the [webpages](https://contributorshipcollaboration.github.io/) for this contributorship-collaboration org, utilising content from the subsidiary repositories (so far only the credit-translation one), and [hugo](https://gohugo.io/) with the [hugo-fresh](https://github.com/StefMa/hugo-fresh) theme, modified.
